...
const Dashboard = () => {
    ...
    useEffect(() => {
        const getUsers = async () => {
            const response = await fetch('https://read-6yer.onrender.com/api/user/users')
    ...
    useEffect(() => {
        ...
        const approveSignUpReq = async () => {
            ...
            const response = await fetch(`https://read-6yer.onrender.com/api/user/${upIdCh}`,{
                method: 'PATCH',
    ...
    useEffect(() => {
        ...
        const deleteSignUpReq = async () => {
            const response = await fetch(`https://read-6yer.onrender.com/api/user/${delIdCh}`, {
                method: 'DELETE'
            })
    ...
    useEffect(() => {
        ...
        const ApprovePdf = async () => {
            const response = await fetch(`https://read-6yer.onrender.com/api/file/${upPdfCh}`,{
                method: 'PATCH',
    ...
    useEffect(() => {
        const deletePdf = async () => {
            const response = await fetch(`https://read-6yer.onrender.com/api/file/${delPdfCh}`, {
                method: 'DELETE'
            })
