...
const Home = () => {
    ...
    const bgSpanNone = {}
    const formSt = {gridTemplateColumns: `${(searchData.length > 0 && pdfArr[0].length !== 0) ? '49% 49%' : '98%'}`}
    ...
    return(
        <div id="home">
            <div id="pdfLinks">
                ...
                {pdfArr[0].length === 0 && <div className="loading">
                    <div></div>
                    <div></div>
                    <div></div>
                    <div></div>
                ...
                {pdfArr[0].length > 0 && <div id="pdfConLinks">
            ...
            <div id="searchdiv">
                <form id="searchform" onSubmit={searchFunc}>
                    ...
                    <div id="formButtons" style={formSt}>
                        <button>Search</button>{(searchData.length > 0 && pdfArr[0].length !== 0)&& <button onClick={goBck}>Go Back</button>}
                    </div>
                </form>
                <div id="strandfilter">
